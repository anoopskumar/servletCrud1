...
public class EmpDao {
    public static Connection getConnection(){  
        ...
        try{  
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/crud2","root","");  
...
//     public static List<Emp> getAllEmployeesByName(String name){  
//        List<Emp> list=new ArrayList<Emp>();  
//          
//        try{  
//            Connection con=EmpDao.getConnection();  
//            PreparedStatement ps=con.prepareStatement("select * from user1 where name=?");  
//             ps.setString(1,name); 
//            ResultSet rs=ps.executeQuery();  
//            while(rs.next()){  
//                Emp b=new Emp();  
